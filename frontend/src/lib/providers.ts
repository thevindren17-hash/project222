...
export const VOICE_STT_PROVIDERS = [
  {
    ...
    badge: null,
    description: 'Industry-leading accuracy and <300ms latency. Best for English and Mandarin voice calls.',
    recommended: true,
    keyPlaceholder: 'dg_...',
    keyUrl: 'https://console.deepgram.com',
    supportsLanguages: ['English', 'Mandarin', '30+ languages'],
  },
  {
    id: 'elevenlabs',
  ...
  },
  {
    ...
    name: 'Groq Whisper',
    badge: 'Free',
    description: 'Whisper Large v3 Turbo via Groq — free and fast. Uses your existing Groq API key.',
    recommended: false,
    keyPlaceholder: 'gsk_...',
    keyUrl: 'https://console.groq.com/keys',
...
export const VOICE_TTS_PROVIDERS = [
  {
    ...
    name: 'ElevenLabs',
    badge: 'Best quality',
    description: 'Most natural voices. Auto-detects Malay/Mandarin/Tamil from text. Recommended for Malaysian clinics.',
    recommended: true,
    keyPlaceholder: 'sk_...',
    keyUrl: 'https://elevenlabs.io',
    voices: [
      // ── Maya receptionist voices (custom, tuned for Malaysian clinic context) ──
      { id: 'kdmDKE6EkgrWrrykO9Qt', name: 'Maya — Receptionist EN (Default)' },
      { id: 'qAJVXEQ6QgjOQ25KuoU8', name: 'Maya — Receptionist MS (Malay)' },
      { id: 'tOuLUAIdXShmWH7PEUrU', name: 'Maya — Receptionist ZH (Mandarin)' },
      { id: 'mGboHvCVOXWYeFL8KTR0', name: 'Maya — Receptionist TA (Tamil)' },
      // ── Multilingual voices (eleven_turbo_v2_5, auto language detection) ──
